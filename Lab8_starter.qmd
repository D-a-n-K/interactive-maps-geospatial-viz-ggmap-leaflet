...
author: "Team Name: [Add Team Name] | Team Members: [Add All Member Names]"
date: today
format: 
  pdf:
    titlepage: true
...
execute:
  ...
  echo: true
  python:
    executable: "path/to/your/python"  # UPDATE THIS PATH
editor: source
---
...
- Your full name
- Your assigned role (Part 1, 2, 3, or 4)
- A brief description of your responsibility
...
# UPDATE THE PATH BELOW TO YOUR PYTHON ENVIRONMENT
library(reticulate)
use_condaenv("path/to/your/python/environment", required = TRUE)
```
